...
5. **GPT-assisted annotation**: `PROMPTS/FROZEN_PROMPT_V2.txt` is the frozen V2 schema/codebook. `SCRIPTS/annotation/` documents balanced-sample construction and resumable annotation. No API call is needed to inspect this package.
