...
| `MAPPINGS/README.md` | Frozen researcher-led topic mapping or mapping documentation |
| `MAPPINGS/cross_industry_pooled_topic_meta_mapping_FINAL.csv` | Frozen researcher-led topic mapping or mapping documentation |
| `MAPPINGS/explicit_boundary_meta_theme_summary_human_verified.csv` | Frozen researcher-led topic mapping or mapping documentation |
| `MAPPINGS/explicit_boundary_meta_theme_to_reporting_theme_hierarchy.csv` | Frozen researcher-led topic mapping or mapping documentation |
| `MAPPINGS/explicit_boundary_original_topic_to_reporting_theme_mapping.csv` | Frozen researcher-led topic mapping or mapping documentation |
| `MAPPINGS/explicit_boundary_reporting_theme_summary_human_verified.csv` | Frozen researcher-led topic mapping or mapping documentation |
| `OUTPUTS/figures/FIG4_explicit_boundary_reporting_themes_cyan_blue_with_legend_no_title.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/FIG4_explicit_boundary_reporting_themes_cyan_blue_with_legend_no_title.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/FIG5_explicit_boundary_meta_themes_by_industry_with_overall_share_no_title.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/FIG5_explicit_boundary_meta_themes_by_industry_with_overall_share_no_title.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/FIGURE_MANIFEST.json` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig1_largest_manually_reviewed_topics_by_industry_no_title.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig1_largest_manually_reviewed_topics_by_industry_no_title.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig1_pooled_topic_prevalence.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig1_pooled_topic_prevalence.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig2_pooled_topic_industry_composition_100pct.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig2_pooled_topic_industry_composition_100pct.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig3_pooled_topic_industry_enrichment.pdf` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/figures/fig3_pooled_topic_industry_enrichment.png` | Non-sensitive publication figure or figure manifest |
| `OUTPUTS/lexical/explicit_boundary_lexical_analysis_metrics.json` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/explicit_boundary_lexical_analysis_report.md` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/explicit_boundary_prevalence_by_industry.csv` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_explicit_boundary_prevalence_by_industry.pdf` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_explicit_boundary_prevalence_by_industry.png` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_top_boundary_positive_keyness_1gram_blue.pdf` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_top_boundary_positive_keyness_1gram_blue.png` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_top_boundary_positive_keyness_1gram_blue_data.csv` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_top_boundary_positive_keyness_2gram_no_title.pdf` | Non-sensitive lexical aggregate or figure |
| `OUTPUTS/lexical/figure_top_boundary_positive_keyness_2gram_no_title.png` | Non-sensitive lexical aggregate or figure |
...
| `OUTPUTS/summary_tables/explicit_boundary_meta_theme_by_industry_long.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/explicit_boundary_meta_theme_by_industry_percent.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/explicit_boundary_model_overview.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/explicit_boundary_topic_by_industry_counts.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/explicit_boundary_topic_by_industry_within_industry_share.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/explicit_boundary_topic_domination_audit.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/industry_model_summary.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/industry_reporting_topics_after_manual_decisions.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/industry_trust_summary.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/pooled_final_topic_mapping_substantive.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/pooled_topic_by_industry_counts_substantive.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/pooled_topic_industry_composition_percent.csv` | Non-sensitive aggregate source table |
| `OUTPUTS/summary_tables/pooled_topic_industry_log2_enrichment.csv` | Non-sensitive aggregate source table |
